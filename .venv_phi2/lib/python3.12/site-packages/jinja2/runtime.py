...
from .utils import _PassArg, concat, internalcode, missing, object_type_repr, pass_eval_context
...
class Macro:
    ...
    def __call__(self, *args: t.Any, **kwargs: t.Any) -> str:
        ...
        if self.catch_varargs:
            ...
            raise TypeError(
                f"macro {self.name!r} takes not more than" f" {len(self.arguments)} argument(s)"
            )
