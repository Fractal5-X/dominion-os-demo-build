...
class MultiDict(TypeConversionDict[K, V]):
    ...
    def getlist(self, key: K, type: cabc.Callable[[V], T] | None = None) -> list[V] | list[T]:
    ...
    def setlistdefault(self, key: K, default_list: cabc.Iterable[V] | None = None) -> list[V]:
    ...
    def __ior__(  # type: ignore[override]
        self,
        other: cabc.Mapping[K, V | list[V] | tuple[V, ...] | set[V]] | cabc.Iterable[tuple[K, V]],
    ) -> te.Self:
