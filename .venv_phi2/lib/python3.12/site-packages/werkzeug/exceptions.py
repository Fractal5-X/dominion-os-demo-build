...
class LengthRequired(HTTPException):
    ...
    code = 411
    description = (
        "A request with this method requires a valid <code>Content-" "Length</code> header."
    )
...
class Aborter:
    ...
    def __call__(self, code: int | SansIOResponse, *args: t.Any, **kwargs: t.Any) -> t.NoReturn:
